                                ...
                                <fieldset class="govuk-fieldset">
                                    ...
                                    <div class="govuk-form-group ">
                                        <select id="location-autocomplete" class="autocomplete__input autocomplete__input--default" name="country">
                                            ...
                                            <option value="BAT">British Antarctic Territory</option>
                                            ...
                                            <option value="AE-DU">Dubai</option>
                                            ...
                                            <option value="AE-FU">Fujairah</option>
                                            ...
                                            <option value="UM-71">Midway Islands</option>
                                            ...
                                            <option value="AE-RK">Ras al-Khaimah</option>
                                            ...
                                            <option value="AE-SH">Sharjah</option>
                                            ...
                                            <option value="AE-UQ">Umm al-Quwain</option>
